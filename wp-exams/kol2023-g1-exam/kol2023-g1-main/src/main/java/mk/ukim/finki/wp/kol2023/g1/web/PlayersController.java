...
import mk.ukim.finki.wp.kol2023.g1.service.impl.TeamServiceImpl;
...
public class PlayersController {
    ...
    public PlayersController(PlayerService playerService, TeamServiceImpl teamService) {
    ...
    public String showPlayers(@RequestParam(required = false) Double pointsPerGame,
        ...
        model.addAttribute("players", displayPlayers);
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("pathURL", "/players");
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("positions", PlayerPosition.values());
        model.addAttribute("teams", teamService.listAll());
        model.addAttribute("pathURL", "/players/" + id);
