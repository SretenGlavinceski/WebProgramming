...
import mk.ukim.finki.wp.june2021.service.impl.MatchLocationServiceImpl;
import mk.ukim.finki.wp.june2021.service.impl.MatchServiceImpl;
...
public class MatchesController {
    ...
    public MatchesController(MatchServiceImpl service, MatchLocationServiceImpl matchLocationService) {
    ...
    public String showMatches(@RequestParam(required = false) Double price,
                              ...
                              Model model) {
        model.addAttribute("matches", matchService.listMatchesWithPriceLessThanAndType(price, type));
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("pathURL", "/matches");
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("types", MatchType.values());
        model.addAttribute("locations", matchLocationService.listAll());
        model.addAttribute("pathURL", "/matches/" + id);
        return "form";
    }
    ...
    public String create(@RequestParam String name,
        ...
        matchService.create(name, description, price, type, location);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam MatchType type,
                         @RequestParam Long location) {
        matchService.update(id, name, description, price, type, location);
        return "redirect:/matches";
    }
