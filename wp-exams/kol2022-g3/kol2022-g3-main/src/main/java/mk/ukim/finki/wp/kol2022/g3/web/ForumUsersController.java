...
public class ForumUsersController {
    ...
    public String showList(@RequestParam(required = false) Long interestId,
        ...
        if (interestId == null && age == null) {
            forumUsers = this.forumUserService.listAll();
        } else {
            forumUsers = this.forumUserService.filter(interestId, age);
        }
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("pathURL", "/users");
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("interests", interestService.listAll());
        model.addAttribute("types", ForumUserType.values());
        model.addAttribute("user", forumUserService.findById(id));
        model.addAttribute("pathURL", "/users/" + id);
        return "form";
    }
