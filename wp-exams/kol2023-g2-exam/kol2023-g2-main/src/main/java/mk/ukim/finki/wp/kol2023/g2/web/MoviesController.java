...
import mk.ukim.finki.wp.kol2023.g2.service.impl.DirectorServiceImpl;
...
public class MoviesController {
    ...
    public MoviesController(MovieService movieService, DirectorServiceImpl directorService) {
    ...
    public String showMovies(@RequestParam(required = false) Double rating,
                             ...
                             Model model) {
        List<Movie> movies = this.movieService.listMoviesWithRatingLessThenAndGenre(rating, genre);
    ...
    public String showAdd(Model model) {
        ...
        model.addAttribute("pathURL", "/movies");
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("genres", Genre.values());
        model.addAttribute("directors", directorService.listAll());
        model.addAttribute("pathURL", "/movies/" + id);
        return "form";
    }
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam String description,
                         @RequestParam Double rating,
                         @RequestParam Genre genre, Long director) {
