...
import mk.ukim.finki.wp.jan2024g2.service.impl.PostServiceImpl;
import mk.ukim.finki.wp.jan2024g2.service.impl.TagServiceImpl;
...
public class PostsController {
    ...
    public PostsController(PostServiceImpl postService, TagServiceImpl tagService) {
    ...
    public String showAdd(Model model) {
        model.addAttribute("postTypes", PostType.values());
        model.addAttribute("tags", tagService.listAll());
        model.addAttribute("pathURL", "/posts");
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("pathURL", "/posts/" + id);
        return "form";
    }
